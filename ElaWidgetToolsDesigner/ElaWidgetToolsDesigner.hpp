...
DECLARE_ELAWIDGET_PLUGIN( ElaCalendar );
DECLARE_ELAWIDGET_PLUGIN( ElaCalendarPicker );
DECLARE_ELAWIDGET_PLUGIN( ElaCheckBox );
DECLARE_ELAWIDGET_PLUGIN( ElaComboBox );
DECLARE_ELAWIDGET_PLUGIN( ElaCentralStackedWidget );

DECLARE_ELAWIDGET_PLUGIN( ElaDockWidget );
DECLARE_ELAWIDGET_PLUGIN( ElaDoubleSpinBox );

DECLARE_ELAWIDGET_PLUGIN( ElaFrame );

DECLARE_ELAWIDGET_PLUGIN( ElaIconButton );
DECLARE_ELAWIDGET_PLUGIN( ElaImageCard );
DECLARE_ELAWIDGET_PLUGIN( ElaInteractiveCard );

DECLARE_ELAWIDGET_PLUGIN( ElaKeyBinder );

DECLARE_ELAWIDGET_PLUGIN( ElaLCDNumber );
DECLARE_ELAWIDGET_PLUGIN( ElaLineEdit );
DECLARE_ELAWIDGET_PLUGIN( ElaListView );
DECLARE_ELAWIDGET_PLUGIN( ElaListWidget );

DECLARE_ELAWIDGET_PLUGIN( ElaMessageButton );
DECLARE_ELAWIDGET_PLUGIN( ElaMultiSelectComboBox );

DECLARE_ELAWIDGET_PLUGIN( ElaPivot );
DECLARE_ELAWIDGET_PLUGIN( ElaPlainTextEdit );
DECLARE_ELAWIDGET_PLUGIN( ElaPopularCard );
DECLARE_ELAWIDGET_PLUGIN( ElaProgressBar );
DECLARE_ELAWIDGET_PLUGIN( ElaProgressRing );
DECLARE_ELAWIDGET_PLUGIN( ElaPushButton );

DECLARE_ELAWIDGET_PLUGIN( ElaRadioButton );
DECLARE_ELAWIDGET_PLUGIN( ElaReminderCard );
DECLARE_ELAWIDGET_PLUGIN( ElaRoller );

DECLARE_ELAWIDGET_PLUGIN( ElaScrollArea );
DECLARE_ELAWIDGET_PLUGIN( ElaScrollPageArea );
DECLARE_ELAWIDGET_PLUGIN( ElaSlider );
DECLARE_ELAWIDGET_PLUGIN( ElaSpinBox );
DECLARE_ELAWIDGET_PLUGIN( ElaSuggestBox );

DECLARE_ELAWIDGET_PLUGIN( ElaTabBar );
DECLARE_ELAWIDGET_PLUGIN( ElaTableView );
DECLARE_ELAWIDGET_PLUGIN( ElaTableWidget );
DECLARE_ELAWIDGET_PLUGIN( ElaTabWidget );
DECLARE_ELAWIDGET_PLUGIN( ElaText );
DECLARE_ELAWIDGET_PLUGIN( ElaToggleButton );
DECLARE_ELAWIDGET_PLUGIN( ElaToggleSwitch );
DECLARE_ELAWIDGET_PLUGIN( ElaToolBar );
DECLARE_ELAWIDGET_PLUGIN( ElaToolButton );
DECLARE_ELAWIDGET_PLUGIN( ElaTreeView );
DECLARE_ELAWIDGET_PLUGIN( ElaTreeWidget );

DECLARE_ELAWIDGET_PLUGIN( ElaDialog );
DECLARE_ELAWIDGET_PLUGIN( ElaWidget );
DECLARE_ELAWIDGET_PLUGIN( ElaWindow );
