...
void ElaSpinBoxStyle::drawComplexControl(ComplexControl control, const QStyleOptionComplex* option, QPainter* painter, const QWidget* widget) const
{
    ...
    case QStyle::CC_SpinBox:
    {
        ...
        painter->drawText(addLineRect, Qt::AlignCenter, _pButtonMode == ElaSpinBoxType::PMSide ? QChar((int)ElaIconType::Plus) : QChar((int)ElaIconType::AngleUp));
        //减小图标
        painter->drawText(subLineRect, Qt::AlignCenter, _pButtonMode == ElaSpinBoxType::PMSide ? QChar((int)ElaIconType::Minus) : QChar((int)ElaIconType::AngleDown));
        painter->restore();
        return;
    }
    default:
